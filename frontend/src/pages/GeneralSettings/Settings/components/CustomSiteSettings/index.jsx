    ...
    >
      ...
      <div className="w-fit">
        ...
        <div className="flex items-center gap-x-2">
          <img
            src={settings.faviconUrl ?? "/athena-mark.svg"}
            onError={(e) => (e.target.src = "/athena-mark.svg")}
      ...
      {hasChanges && (
        <button
          type="submit"
          className="motion-hover mt-2 w-fit border border-slate-200 px-5 py-2.5 rounded-lg text-white text-sm items-center flex gap-x-2 hover:bg-slate-200 hover:text-slate-800 focus:ring-gray-800"
        >
          Save
        </button>
      )}

          ...
          <form onSubmit={handleCreate}>
            <div className="space-y-6 max-h-[60vh] overflow-y-auto pr-2">
              ...
              <p className="text-white text-opacity-60 text-xs md:text-sm">
                After clicking "Create API Key", Athena will attempt to connect
                to your browser extension automatically.
              </p>
              <p className="text-white text-opacity-60 text-xs md:text-sm">
                If you see "Connected to Athena" in the extension, the
            ...
            <div className="flex justify-between items-center mt-6 pt-6 border-t border-theme-modal-border">
              {!apiKey ? (
                ...
                <button
                  ...
                  type="button"
                  disabled={copied}
                  className="w-full motion-hover bg-white text-black hover:opacity-60 px-4 py-2 rounded-lg text-sm cursor-pointer"
                >

    ...
    <div className="w-full max-w-2xl bg-theme-bg-secondary rounded-lg shadow border-2 border-theme-modal-border overflow-hidden z-9999">
      ...
      <div className="flex w-full justify-end items-center p-6 space-x-2 border-t border-theme-modal-border rounded-b">
        <button
          onClick={onClose}
          type="button"
          className="motion-hover bg-transparent text-white hover:opacity-60 px-4 py-2 rounded-lg text-sm border-none"
        >
          Cancel
        </button>
        <button
          onClick={onConfirm}
          type="submit"
          className="motion-hover bg-red-500 light:text-white text-white hover:opacity-60 px-4 py-2 rounded-lg text-sm border-none"
        >
          Confirm
        </button>
      </div>

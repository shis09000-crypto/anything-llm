...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "Athena funciona com vários provedores de LLM. Este será o serviço que lidará com os chats.",
    },
    userSetup: {
    ...
    survey: {
      title: "Bem-vindo ao Athena",
      description: "Ajude-nos a melhorar o Athena. Opcional.",
      email: "Qual seu email?",
      useCase: "Como você usará o Athena?",
      useCaseWork: "Para trabalho",
      useCasePersonal: "Uso pessoal",
      useCaseOther: "Outro",
      comment: "Como você conheceu o Athena?",
      commentPlaceholder:
  ...
  agent: {
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        ...
        "beta-badge": "Beta",
        description:
          "Permita o uso ilimitado de ferramentas e reduza o consumo de tokens em até 80% por consulta — O Athena seleciona automaticamente as habilidades mais adequadas para cada solicitação.",
        "max-tools": {
  ...
  customization: {
    ...
    branding: {
      ...
      description: "Personalize sua instância do Athena com sua marca.",
    },
    chat: {
      title: "Chat",
  ...
  api: {
    ...
    modal: {
      ...
      helper:
        "Depois de criada, a chave de API pode ser usada para acessar e configurar esta instância do Athena programaticamente.",
      name: {
        label: "Nome",
  ...
  transcription: {
    ...
    "warn-start":
      "Usar o modelo local whisper em máquinas com RAM ou CPU limitada pode travar o Athena.",
  ...
  privacy: {
    ...
    description:
      "Configurações de como provedores terceiros e o Athena lidam com seus dados.",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Esses arquivos são enviados ao processador local do Athena. Não são compartilhados com terceiros.",
    },
    pinning: {
  ...
  telegram: {
    ...
    description:
      "Conecte sua instância do Athena ao Telegram para que possa conversar com seus espaços de trabalho a partir de qualquer dispositivo.",
    setup: {
      step1: {

...
const TRANSLATIONS = {
  ...
  "onboarding": {
    ...
    "llm": {
      "title": "LLM 偏好",
      "description": "Athena可以与多家 LLM 提供商配合使用。这将是处理聊天的服务。"
    },
    "userSetup": {
      "title": "用户设置",
  ...
  "common": {
    ...
    "controls": {
      "settings": "设置",
      "settingsDescription": "打开系统设置，调整界面、模型提供商、安全和工作区管理等配置。",
      "workspaceSettings": "工作区设置",
      "workspaceSettingsDescription": "打开此工作区设置，调整外观、文档、成员和行为配置。",
  ...
  "reading-tools": {
    "eyebrow": "阅读工具",
    "title": "字体大小与阅读预览",
    "description": "这是全局界面偏好，会实时应用到聊天区、输入框和阅读预览；修改会同步到账户，后台只保存最后一次调整。",
    "sizeTitle": "字号选择",
    "previewTitle": "实时预览",
  ...
  "workspace-health": {
    ...
    "title": "工作区健康中心",
    "eyebrow": "工作区可观察性",
    "description": "这里展示知识图谱、修复任务、节点指标、后台 Worker、队列、模型服务与缓存的轻量可观察状态。刷新只更新健康聚合缓存，不会触发嵌入、向量重建、知识图谱提取或修复任务。",
    "refresh": "刷新健康状态",
    ...
    "cacheNote": "缓存说明：当前有 {{count}} 条过期 traversal 缓存。缓存会按需重建，不影响健康分数。",
  ...
  "system-prompt-variables": {
    "title": "系统提示变量",
    "description": "系统提示变量用于保存配置值，可在系统提示词中引用，以便在提示词中启用动态内容。",
    "addVariable": "添加变量",
    "noVariables": "未找到变量",
    "edit": "编辑",
    "columns": {
    ...
    "form": {
      ...
      "keyHint": "键必须唯一，并会以 {key} 的形式在提示词中使用。只允许使用字母、数字和下划线。",
      "cancel": "取消",
      "create": "创建变量",
      "update": "更新变量"
    },
  ...
  "experimental-features": {
    ...
    "tos": {
      ...
      "optIn": "主动选择启用",
      "optInSuffix": "。",
      "introEnd": "在批准任何功能之前，如存在潜在问题，我们会主动给出条件说明或警告。",
      ...
      "conditions": {
        ...
        "availability": "该功能未来可能无法在某些版本、配置或 Athena 订阅中使用。",
      ...
      "moreInfoPrefix": "访问任何功能都需要先同意此弹窗。如果想了解更多信息，可以查看",
    ...
    "liveSync": {
      "navTitle": "实时文档同步",
      "title": "自动文档内容同步",
      "description": "启用后可以指定要“监视”的文档。被监视文档的内容会定期获取并更新到 Athena。",
      "workspaceUpdate": "被监视的文档会在更新时同步更新到所有引用它们的工作区。",
      "webOnly": "此功能仅适用于基于 Web 的内容，例如网站、Confluence、YouTube 和 GitHub 文件。",
      "docsLink": "功能文档和警告",
      "manageLink": "管理被监视的文档",
      "toasts": {
        "enabled": "实时文档内容同步已启用。",
      ...
      "manage": {
        "title": "被监视的文档",
        "description": "这里列出当前实例中所有正在被监视的文档。这些文档的内容会定期同步。",
        "columns": {
          "documentName": "文档名称",
          "lastSynced": "上次同步",
          "nextRefresh": "距离下次刷新",
  ...
  "audio-preference": {
    "stt": {
      "title": "语音转文本偏好",
      "description": "在这里可以指定你希望在 Athena 体验中使用哪种文本转语音和语音转文本提供商。默认情况下，我们使用浏览器内置的这些服务支持，但你也可以使用其他提供商。",
      "searchPlaceholder": "搜索语音转文本提供商"
    },
    "tts": {
      "title": "文本转语音偏好",
      "description": "在这里可以指定你希望在 Athena 体验中使用哪种文本转语音提供商。默认情况下，我们使用浏览器内置的这些服务支持，但你也可以使用其他提供商。",
    ...
    "piper": {
      "description": "所有 PiperTTS 模型都会在你的浏览器中本地运行。低端设备上可能会消耗较多资源。",
    ...
    "openaiCompatible": {
      "baseUrlHint": "这里应填写 OpenAI 兼容 TTS 服务的基础 URL，用于生成 TTS 响应。",
      "apiKeyHint": "某些 TTS 服务需要 API 密钥才能生成 TTS 响应。如果你的服务不需要密钥，则此项可选。",
      ...
      "voiceModelHint": "大多数 TTS 服务会提供多个声音模型，这里填写你想使用的声音模型标识符。"
    }
  },
  "default-system-prompt": {
    ...
    "form": {
      "label": "系统提示词",
      "helpStart": "系统提示词提供用于塑造 AI 回复和行为的指令。此提示词会自动应用到所有新创建的工作区。若要更改",
      "helpStartSeparator": " ",
      "specificWorkspace": "特定工作区",
      "helpMiddle": "的系统提示词，请在",
      "helpMiddleSeparator": " ",
      "workspaceSettings": "工作区设置",
      "helpEnd": "中编辑提示词。若要将系统提示词恢复为我们的合理默认值，请留空此字段并保存更改。",
      ...
      "syncExistingHint": "仅更新仍使用旧默认提示词的工作区，不覆盖单独自定义过的系统提示词。"
    },
    "toasts": {
      "updated": "默认系统提示词已成功更新。",
      "updatedWithSync": "默认系统提示词已成功更新。已同步 {{synced}} 个工作区，跳过 {{skipped}} 个自定义工作区，失败 {{failed}} 个。",
  ...
  "chat": {
    ...
    "mode": {
      ...
      "chat": {
        "title": "聊天",
        "description": "将使用 LLM 的通用知识 <b>和</b> 找到的文档上下文来提供答案。<br />您需要使用 @agent 命令来使用工具。"
      },
      "query": {
        "title": "查询",
        "description": "将<b>仅</b>在找到文档上下文时提供答案。<br />您需要使用 @agent 命令来使用工具。"
      },
      "automatic": {
  ...
  "agent": {
    ...
    "skill": {
      "cryptoMarket": {
        "title": "加密货币行情",
        "description": "通过 Gate 和 Binance 查询只读公开现货价格及市场快照，不访问私人账户，也不会执行交易。"
      },
      "weather": {
        "title": "天气查询",
        "description": "通过和风天气按中国城市或 GPS 坐标查询实况及 3、7、10、15、30 天预报。"
      },
      "globalMarket": {
        "title": "全球市场",
        "description": "通过聚合数据、Stooq 和 Frankfurter 查询只读外汇、指数、股票、商品、基金及 ETF 行情。"
      },
      "marketData": {
        "credentials": "供应商密钥",
        "configured": "已配置",
        ...
        "secretHelp": "密钥会使用 Athena 当前活动数据密钥加密保存。已有密钥不会再次显示；只有需要替换时才输入新值。"
      },
      "rag": {
        "title": "检索增强生成和长期记忆",
      ...
      "surveys": {
        ...
        "description": "允许代理在继续执行前向用户提出最多 3 个澄清问题，并提供推荐选项与自定义输入。"
      },
      "generate": {
        "title": "生成图表",
      ...
      "documentFormatting": {
        "title": "DOCX 排版优化",
        "description": "将当前工作区的 Word 文档优化为新的 DOCX 副本。优先保留图片、表格、页眉页脚等结构，无法安全保真时会从解析内容重建并提示；不会覆盖源文件，每次写入前都会请求确认。"
      },
      "gmail": {
        "title": "Gmail 连接器",
        "description": "让您的智能体与 Gmail 交互 - 搜索电子邮件、阅读邮件线程、撰写草稿、发送电子邮件并管理您的收件箱。 <a>阅读文档</a>。",
      ...
      "outlook": {
        "title": "Outlook 连接器",
        "description": "让您的智能体与 Microsoft Outlook 交互 - 通过 Microsoft Graph API 搜索电子邮件、阅读邮件线程、撰写草稿、发送电子邮件并管理您的收件箱。 <a>阅读文档</a>。",
      ...
      "googleCalendar": {
        "title": "Google 日历连接器",
        "description": "让您的智能体与 Google Calendar 交互 - 查看日历、获取事件、创建和更新事件以及管理 RSVP。 <a>阅读文档</a>。",
    ...
    "mcp": {
      ...
      "tool-count-warning": "此 MCP 服务器已启用 <b>{{count}} 个工具</b>，这些工具将在每次聊天中消耗上下文。<br />请考虑禁用不需要的工具以节省上下文。",
    ...
    "settings": {
      ...
      "intelligent-skill-selection": {
        "title": "智能技能选择",
        "beta-badge": "β 版本",
        "description": "实现无限工具调用，并将每次查询的 Token 使用量最高减少 80%——Athena能够为每个提示自动选择最合适的技能。",
        "max-tools": {
          "title": "麦克斯工具",
      ...
      "clarifying-questions": {
        "title": "允许代理提出澄清问题",
        "beta-badge": "β 版本",
        "description": "启用后，当提示不明确时，代理可以暂停并向你提出简短的澄清问题。",
        "limit-note": "每轮最多 3 个问题，每个问题最多 150 字。"
      }
    }
  },
  "recorded": {
  ...
  "customization": {
    ...
    "items": {
      ...
      "motion-density": {
        ...
        "guide": {
          "title": "速度指引",
          "description": "小圆点会预览当前档位的节奏：移动距离越短越克制快速，移动距离越长越完整明显。"
        },
        "options": {
          "minimal": {
            "label": "轻量",
  ...
  "rerank": {
    "title": "重排模型首选项",
    "description": "配置用于向量检索结果重排的提供商和模型。开启工作区的准确率优化检索后，会使用这里的重排设置。",
    "provider": "重排提供商",
    "providerHint": "默认使用系统自带重排模型。只有在已准备好 DashScope API Key，并希望使用托管 qwen3 重排时，再切换到阿里百炼。",
    "providers": {
      "native": {
        "name": "系统自带重排",
        "description": "使用Athena内置的本地重排模型，不需要 API Key 或托管接口。"
      },
      "alibaba": {
        "name": "阿里百炼 DashScope",
    ...
    "model": "重排模型",
    "nativeHelp": "系统自带重排会使用本地内置模型完成候选片段排序，因此不需要填写 API Key、Base URL 或模型名。在未配置阿里百炼重排前，会优先使用这个默认模式。",
  ...
  "search_model": {
    "title": "搜索模型首选项",
    "description": "配置专门用于搜索相关推理与结果处理的托管模型。这个设置不会改变当前选择的网络搜索引擎。",
    "provider": "搜索模型提供商",
    "providerHint": "默认不启用托管搜索模型。只有在已准备好 DashScope API Key 后，再切换到阿里百炼。",
    "providers": {
      "none": {
        "name": "无",
  ...
  "ocr": {
    ...
    "provider": "OCR 提供商",
    "providerHint": "默认不启用托管 OCR。只有在已准备好 DashScope API Key，并希望使用阿里 OCR 模型处理扫描文本时，再切换到阿里百炼。",
    "providers": {
      "none": {
        "name": "无",
    ...
    "model": "OCR 模型",
    "noneHelp": "当前不会调用托管 OCR 模型。阅读器仍可使用已有文本层和本地解析结果，但扫描版 PDF 或图片的 OCR 后处理会保持未配置状态。",
  ...
  "vision": {
    ...
    "provider": "视觉模型提供商",
    "providerHint": "默认不启用托管视觉模型。只有在已准备好 DashScope API Key，并希望配置阿里视觉模型时，再切换到阿里百炼。",
    "providers": {
      "none": {
        "name": "无",
    ...
    "model": "视觉模型",
    "noneHelp": "当前没有配置托管视觉模型。这里仅控制全局视觉模型首选项，不会单独改变 OCR 或聊天行为。",
    "help": "阿里百炼视觉模型会使用 DashScope OpenAI-compatible 接口。请填写 DashScope API Key、Base URL 和模型名。",
    "toolToggle": {
      "label": "启用图片预分析",
      "description": "当聊天消息包含图片时，先用视觉模型分析图片，再把分析结果交给主会话模型。",
      "disabledDescription": "可以保持开启，但只有配置阿里百炼后才会实际执行图片预分析。"
    },
    "save": "保存更改",
    "saving": "正在保存...",
    "saved": "视觉模型设置已保存。",
  ...
  "llm": {
    "title": "LLM 首选项",
    "description": "这些是你首选的 LLM 聊天和嵌入提供商的凭据和设置。请确保这些密钥保持最新且正确，否则Athena将无法正常运行。",
    "provider": "LLM 提供商",
    "providers": {
      "azure_openai": {
  ...
  "provider_preset": {
    ...
    "success_toast": "已应用 DeepSeek V4 Pro + 阿里 text-embedding-v4 + 阿里搜索模型 + 阿里 OCR + 阿里视觉模型配置"
  },
  "transcription": {
    "title": "转录模型首选项",
    "description": "这些是你的首选转录模型提供商的凭据和设置。重要的是这些密钥是最新且正确的，否则媒体文件和音频将无法转录。",
    "provider": "转录提供商",
    "warn-start": "在 RAM 或 CPU 有限的计算机上使用本地 Whisper 模型时，Athena可能会在处理媒体文件时卡住。",
    "warn-recommend": "我们建议至少 2GB RAM 并上传 <10Mb 的文件。",
    "warn-end": "内置模型将在首次使用时自动下载。"
  },
  "embedding": {
    "title": "向量引擎",
    "desc-start": "Athena Vector Engine 将文档、对话和知识内容转化为可检索的语义向量。",
    ...
    "document-mode": {
      ...
      "batch": {
        ...
        "description": "文件上传后创建异步批处理任务，成本更低，但需要等待任务完成后文档才可被检索。"
      },
  ...
  "vector": {
    ...
    "description": "配置 Athena Vector Engine 存储语义向量的位置，为检索与推理提供基础。",
    "provider": {
      "title": "向量存储提供商",
  ...
  "connectors": {
    ...
    "upload": {
      ...
      "fetching": "正在获取...",
      "fetch-website": "获取网站",
      "privacy-notice": "这些文件将被上传到此Athena实例上的文档处理器。这些文件不会发送或共享给第三方。"
    },
    "document-status": {
      "uploading": "上传中",
      "waiting": "等待处理",
    ...
    "pinning": {
      ...
      "pin_explained_block1": "当您在Athena中<b>固定</b>一个文档时，我们会将整个文档内容注入到您的提示窗口中，让 LLM 能够完全理解它。",
      "pin_explained_block2": "这在 <b>大上下文模型</b> 或关键的小文件中效果最佳。",
      "pin_explained_block3": "如果默认情况下无法从Athena获取满意的答案，固定文档是提高答案质量的好方法。",
      "accept": "好的，知道了"
    },
    "watching": {
      "what_watching": "什么是监控文档？",
      "watch_explained_block1": "当您在Athena中<b>监控</b>一个文档时，我们会<i>自动</i>按定期间隔从其原始来源同步文档内容。系统会自动更新所有使用该文档的工作区中的内容。",
  ...
  "chat_window": {
    ...
    "controls": {
      "upload": {
        "label": "上传",
        "description": "上传或附加文件。图片仅随本次对话使用，支持的文档也可以进入工作区知识库。",
        "workspaceLabel": "上传文档",
        "workspaceDescription": "上传文档到当前工作区，方便 Athena 后续组织、检索和引用。"
      },
      "quizMode": {
        "label": "测试",
        "description": "开启测试模式。下一条消息会让 Athena 根据你的提示生成测验题。",
      ...
      "fileAccess": {
        ...
        "modes": {
          ...
          "open": {
            "label": "完全开放模式",
            "description": "在确认后允许更广泛的本机文件和终端访问，风险较高，请谨慎使用。"
          }
        },
        "openConfirm": {
          "title": "开启完全开放文件访问？",
          "description": "完全开放模式会授予更宽的本地文件访问权限，并可能在批准后执行 shell 命令。",
          "confirm": "继续"
        }
      }
    },
    ...
    "turnState": {
      "reconnecting": "正在重新连接…",
      "saving": "正在安全保存…",
      "saveRetrying": "回复已保留，安全保存将在后台重试。",
      "loadingFullResponse": "正在加载完整回复…",
      "retryFullResponse": "重试加载完整回复",
      "loadFullResponse": "加载完整回复",
      "loadingConversation": "正在加载对话内容",
      "responseFailed": "无法回复此消息。",
      "reconnectLimitPrompt": "智能体连接已达到重试上限。是否使用已记录的工具结果和部分回答继续？",
      "reconnect": "重新连接",
      "keepInterrupted": "保留中断状态",
      "errorReason": "原因：",
      "unknownError": "未知错误"
    },
    "toolTimeline": {
      ...
      "progress": {
        "runningSummary": "{{phase}} · 已完成 {{count}} 步 · {{elapsed}} {{stillWorking}}",
        "completedSummary": "智能体已完成 · {{count}} 步 · 检索到 {{evidence}} 段资料 · {{elapsed}}",
      ...
      "agentTemporarilyUnavailable": "智能体服务暂时不可用。您的消息已保留，请稍后重试。",
      "agentFallbackToChat": "无法启动请求的智能体{{targets}}，将继续使用普通聊天。",
      "agentTargetLabel": "（{{targets}}）",
      "reconnecting": "智能体连接中断，正在重新连接（{{attempt}}/{{total}}）…",
      "generationStopped": "已停止生成。",
      "agentSessionUnavailable": "当前智能体会话已不再接收新输入。",
      "agentFollowUpSent": "已将后续输入发送到当前智能体会话。",
      "streamAborted": "回复流已中断。",
      "websocketFailed": "实时连接失败。",
      "reconnectFailed": "智能体重新连接失败。",
      "chatStreamFailed": "聊天流在回复完成前已中断。",
      "approvalRequested": "{{skill}} 请求授权",
      "agentError": "智能体错误",
      "toolFallback": "工具",
  ...
  "profile_settings": {
    ...
    "signout_confirm_description": "退出后，此设备上的当前会话会被清除。你可以稍后重新登录。",
  ...
  "security": {
    ...
    "password": {
      "title": "密码保护",
      "description": "用密码保护你的Athena实例。如果你忘记了密码，将无法恢复，所以请务必保存好这个密码。",
      "password-label": "实例密码"
    }
  },
  "home": {
  ...
  "telegram": {
    "title": "Telegram 机器人",
    "description": "将您的Athena实例与 Telegram 连接起来，这样您就可以从任何设备与您的工作空间进行聊天。",
    "setup": {
      "step1": {
        "title": "第一步：创建您的 Telegram 机器人",
        "description": "在 Telegram 中打开 @BotFather，将 <code>/newbot</code> 发送给 <code>@BotFather</code>，按照提示操作，然后复制 API 令牌。",
  ...
  "wechat": {
    ...
    "profile": {
      ...
      "last-connected": "上次连接",
      "placeholder": "暂无",
      "best-effort": "资料字段只读取 OpenClaw 元数据；真实凭证仍由 OpenClaw 保存在本地。"
    },
    "actions": {
      "relogin": "重新登录",
      "disconnect": "断开连接",
    ...
    "errors": {
      "openclaw_not_installed": "未找到 OpenClaw CLI。请先安装 OpenClaw 或设置 OPENCLAW_BIN。",
  ...
  "advancedGateway": {
    "title": "高级连接器",
    "description": "为 Clawbot、Python、Rust 或其他自定义消息转发服务配置外部 Gateway。",
    "enabled": {
      "title": "启用高级连接器",
    ...
    "notes": {
      "title": "Gateway 安全说明",
      "api-secret": "API Secret 用于外部 Gateway 调用 Athena webhook 时生成 HMAC 签名。",
      "gateway-url": "网关地址当前用于记录外部 Gateway 服务地址。",
      "no-wechat-state": "微信登录态、cookie、token 和本地凭证不会保存在 Athena 中。",
      "external-gateway": "真实微信登录、消息接收和消息发送由外部 Gateway、Clawbot 或 OpenClaw 微信插件负责。"
    },
    "fields": {
      "gateway-url": "网关地址",
      "api-key": "API 密钥",
  ...
  "admin": {
    ...
    "users": {
      "title": "用户",
      "description": "这里是当前实例内的全部账户。移除用户后将立刻失去该实例访问权限。",
      "add": "新增用户",
      "table": {
        "username": "用户名",
        "role": "角色",
      ...
      "confirm": {
        "suspend": {
          "title": "暂停用户？",
          "description": "{{username}} 将被注销，并且在管理员恢复访问之前无法登录。",
          "confirm": "暂停"
        },
        "unsuspend": {
          "title": "恢复用户？",
          "description": "{{username}} 将能够重新登录到此实例。",
          "confirm": "恢复"
        },
        "delete": {
          "title": "删除用户？",
          "description": "{{username}} 将被注销并失去对此 Athena 实例的访问权限。此操作无法撤销。",
          "confirm": "删除"
        }
      },
      "toast": {
    ...
    "workspaces": {
      "title": "实例工作区",
      "description": "这是当前实例下全部工作区。删除工作区后，其相关聊天与设置也会一并删除。",
      "create": "新建工作区",
      "table": {
        "name": "名称",
        "link": "链接",
      ...
      "confirm": {
        "delete": {
          "title": "删除工作区？",
          "description": "{{workspaceName}} 将不再在此 Athena 实例中使用，该操作不可恢复。",
          "confirm": "删除"
        }
      }
    },
    "invites": {
      "title": "邀请",
      "description": "为组织内成员创建可领取的邀请链接。每条邀请仅能被一个账号使用。",
      "create": "创建邀请链接",
      "publicRegistration": {
        "title": "允许公开注册",
      ...
      "modal": {
        ...
        "autoAssignDescription": "可选：勾选后会在创建时自动将用户加入所选工作区。默认不加入任何工作区。",
        "cancel": "取消",
        "create": "创建邀请",
  ...
  "scheduledJobs": {
    ...
    "description": "创建可重复执行的 AI 任务，并设置执行时间表。每个任务会执行一个提示，并可以选择使用辅助工具，然后保存结果供后续审查。",
    "newJob": "新工作",
    "loading": "正在加载...",
    ...
    "modal": {
      ...
      "toolsLabel": "工具（可选）",
      "toolsDescription": "选择此任务可以使用的任何代理工具。如果未选择任何工具，则任务将不会使用任何工具。",
      "toolsSearch": "搜索",
    ...
    "builder": {
      "fallbackWarning": "这个表达式无法通过图形界面进行编辑。请选择“自定义”选项来保留它，或者修改下面的内容来覆盖它。",
      "run": "跑步",
      "frequency": {
        "minute": "每分钟",
        "hour": "每小时",

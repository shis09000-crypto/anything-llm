...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "Athena poate funcționa cu mai mulți furnizori LLM. Acesta va fi serviciul care gestionează conversațiile.",
    },
    userSetup: {
    ...
    survey: {
      title: "Bun venit la Athena",
      description:
        "Ajută-ne să facem Athena potrivit pentru nevoile tale. Opțional.",
      email: "Care este adresa ta de email?",
      useCase: "Pentru ce vei folosi Athena?",
      useCaseWork: "Pentru muncă",
      useCasePersonal: "Pentru uz personal",
      useCaseOther: "Altele",
      comment: "De unde ai aflat despre Athena?",
      commentPlaceholder:
  ...
  vector: {
    ...
    description:
      "Acestea sunt credențialele și setările pentru modul în care funcționează instanța ta Athena. Este important să fie corecte și actuale.",
    provider: {
  ...
  privacy: {
    ...
    description:
      "Aceasta este configurația ta pentru modul în care furnizorii terți conectați și Athena gestionează datele tale.",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Aceste fișiere vor fi încărcate în procesorul de documente care rulează pe această instanță Athena. Aceste fișiere nu sunt trimise sau partajate cu o terță parte.",
    },
    pinning: {
      what_pinning: "Ce este fixarea documentelor?",
      pin_explained_block1:
        "Când **fixezi** un document în Athena, vom injecta întregul conținut al documentului în fereastra de prompt pentru ca LLM-ul tău să-l înțeleagă pe deplin.",
      ...
      pin_explained_block3:
        "Dacă nu obții răspunsurile dorite de la Athena în mod implicit, atunci fixarea este o modalitate excelentă de a obține răspunsuri de calitate superioară dintr-un clic.",
      accept: "Ok, am înțeles",
    },
    watching: {
      what_watching: "Ce face vizualizarea unui document?",
      watch_explained_block1:
        "Când **urmărești** un document în Athena, vom sincroniza *automat* conținutul documentului tău din sursa originală la intervale regulate. Acest lucru va actualiza automat conținutul în fiecare spațiu de lucru unde acest fișier este gestionat.",
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          ...
          description:
            "Trebuie să te autentifici cu Athena Community Hub înainte de a publica elemente.",
  ...
  agent: {
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        ...
        "beta-badge": "Beta",
        description:
          "Permite utilizarea nelimitată a instrumentelor și reduce utilizarea token-urilor cu până la 80% pentru fiecare interogare – Athena selectează automat abilitățile potrivite pentru fiecare solicitare.",
        "max-tools": {
          title: "Max Tools",
          description:
  ...
  customization: {
    interface: {
      title: "Preferințe UI",
      description: "Setează preferințele UI pentru Athena.",
    },
    branding: {
      title: "Branding & White-labeling",
      description:
        "Personalizează-ți instanța Athena cu branding personalizat.",
    },
    chat: {
      title: "Chat",
      description: "Setează preferințele de chat pentru Athena.",
      auto_submit: {
    ...
    items: {
      ...
      "display-language": {
        ...
        description:
          "Selectează limba preferată pentru a reda interfața Athena - atunci când traducerile sunt disponibile.",
      },
      logo: {
        title: "Logo brand",
        description:
  ...
  api: {
    title: "Chei API",
    description:
      "Cheile API permit deținătorului să acceseze și să gestioneze programatic această instanță Athena.",
    ...
    modal: {
      ...
      helper:
        "După creare, cheia API poate fi folosită pentru a accesa și configura programatic această instanță Athena.",
      name: {
        label: "Nume",
  ...
  llm: {
    title: "Preferința LLM",
    description:
      "Acestea sunt credențialele și setările pentru furnizorul tău preferat de chat și embedding LLM. Este important ca aceste chei să fie actuale și corecte, altfel Athena nu va funcționa corect.",
  ...
  transcription: {
    ...
    "warn-start":
      "Utilizarea modelului local Whisper pe mașini cu RAM sau CPU limitat poate bloca Athena la procesarea fișierelor media.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "Embedding-ul este procesul de transformare a textului în vectori. Aceste credențiale sunt necesare pentru a transforma fișierele și prompturile dvs. într-un format pe care Athena îl poate utiliza pentru procesare.",
    provider: {
  ...
  security: {
    ...
    password: {
      ...
      description:
        "Protejează instanța Athena cu o parolă. Dacă o uiți, nu există metode de recuperare, deci asigură-te că o salvezi.",
  ...
  telegram: {
    ...
    description:
      "Conectați instanța dumneavoastră Athena cu Telegram, astfel încât să puteți interacționa cu spațiile de lucru de pe orice dispozitiv.",
    setup: {
      step1: {

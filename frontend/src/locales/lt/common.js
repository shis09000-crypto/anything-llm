...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "Athena gali dirbti su daugeliu LLM tiekėjų. Ši paslauga bus atsakinga už pokalbių valdymą.",
    },
    userSetup: {
    ...
    survey: {
      title: "Sveiki atvykę į Athena",
      description:
        "Padėkite mums pritaikyti Athena jūsų poreikiams. Neprivaloma.",
      email: "Koks jūsų el. pašto adresas?",
      useCase: "Kam naudosite Athena?",
      useCaseWork: "Darbui",
      useCasePersonal: "Asmeniniam naudojimui",
      useCaseOther: "Kita",
      comment: "Kaip sužinojote apie Athena?",
      commentPlaceholder:
  ...
  settings: {
    ...
    "mobile-app": "Athena mobiliesiems",
    channels: "Kanalai",
    "available-channels": {
      telegram: "„Telegram“",
    },
  ...
  agent: {
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        ...
        "beta-badge": "Beta",
        description:
          "Įjunkite neribotą kiekį įrankių ir sumažinkite žetonų (tokens) naudojimą iki 80 % vienai užklausai — Athena automatiškai parinks tinkamus įgūdžiai kiekvienai užklausai.",
        "max-tools": {
  ...
  customization: {
    interface: {
      ...
      description: "Nustatykite savo Athena sąsajos nustatymus.",
    },
    branding: {
      title: "Prekės ženklas",
      description:
        "Pritaikykite savo Athena instanciją naudodami savo prekės ženklą.",
    },
    chat: {
      title: "Pokalbiai",
      description: "Nustatykite savo Athena pokalbių nustatymus.",
      auto_submit: {
    ...
    items: {
      ...
      "display-language": {
        title: "Rodymo kalba",
        description:
          "Pasirinkite pageidaujamą Athena sąsajos kalbą (jei yra vertimai).",
      },
      logo: {
  ...
  api: {
    title: "API raktai",
    description:
      "API raktai leidžia programiškai pasiekti ir valdyti šią Athena instanciją.",
    ...
    modal: {
      ...
      helper:
        "Sukūrus API raktą, jį galima naudoti programiškai pasiekti ir konfigūruoti šį Athena egzempliorių.",
      name: {
        label: "Pavadinimas",
  ...
  llm: {
    title: "LLM pasirinkimas",
    description:
      "Tai jūsų pasirinkto LLM pokalbių ir vektorių kūrimo tiekėjo duomenys ir nustatymai. Svarbu, kad šie raktai būtų aktualūs ir teisingi, kitaip Athena neveiks tinkamai.",
  ...
  transcription: {
    ...
    "warn-start":
      "Naudojant vietinį Whisper modelį įrenginiuose su ribotu RAM ar CPU kiekiu, Athena gali sulėtėti apdorojant medijos failus.",
  ...
  embedding: {
    ...
    "desc-end":
      "Vektorių kūrimas (embedding) yra procesas, paverčiantis tekstą skaitmeniniais vektoriais. Šie duomenys reikalingi norint paversti jūsų failus ir užklausas į formatą, kurį Athena gali apdoroti.",
    provider: {
  ...
  vector: {
    ...
    description:
      "Tai nustatymai, kaip veiks jūsų Athena instancija. Svarbu, kad šie duomenys būtų aktualūs ir teisingi.",
    provider: {
  ...
  security: {
    ...
    password: {
      ...
      description:
        "Apsaugokite savo Athena instanciją slaptažodžiu. Jei jį pamiršite, atkūrimo būdo nėra, todėl būtinai jį išsisaugokite.",
  ...
  privacy: {
    ...
    description:
      "Tai jūsų konfigūracija, kaip prijungti trečiųjų šalių tiekėjai ir Athena tvarko jūsų duomenis.",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Šie failai bus įkelti į dokumentų procesorių, veikiantį šioje Athena instancijoje. Šie failai nėra siunčiami ar bendrinami su trečiosiomis šalimis.",
    },
    pinning: {
      what_pinning: "Kas yra dokumento prisegimas?",
      pin_explained_block1:
        "Kai <b>prisegate</b> dokumentą Athena sistemoje, mes įtrauksime visą dokumento turinį į jūsų užklausos langą, kad jūsų LLM jį visiškai suprastų.",
      pin_explained_block2:
        "Tai geriausiai veikia su <b>didelio konteksto modeliais</b> arba mažais failais, kurie yra labai svarbūs žinių bazei.",
      pin_explained_block3:
        "Jei pagal numatytuosius nustatymus negaunate pageidaujamų atsakymų iš Athena, prisegimas yra puikus būdas gauti aukštesnės kokybės atsakymus vienu spustelėjimu.",
      accept: "Gerai, supratau",
    },
    watching: {
      what_watching: "Ką daro dokumento stebėjimas?",
      watch_explained_block1:
        "Kai <b>stebite</b> dokumentą Athena sistemoje, mes <i>automatiškai</i> sinchronizuosime jūsų dokumento turinį iš originalaus šaltinio reguliariais intervalais. Tai automatiškai atnaujins turinį kiekvienoje darbo srityje, kurioje šis failas yra valdomas.",
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          ...
          description:
            "Prieš skelbdami elementus, turite prisijungti prie Athena bendruomenės centro.",
  ...
  telegram: {
    ...
    description:
      "Prisijunkite savo „Athena“ instanciją prie „Telegram“, kad galėtumėte kalbėti su savo darbo vietomis iš bet kurio įrenginio.",
    setup: {
      step1: {

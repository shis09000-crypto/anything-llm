...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "Athena יכול לעבוד עם ספקי מודלי שפה (LLM) רבים. זה יהיה השירות שיטפל בצ'אט.",
    },
    userSetup: {
      title: "הגדרת משתמש",
  ...
  agent: {
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        ...
        "beta-badge": "בטא",
        description:
          "אפשרו שימוש בלתי מוגבל בכלים וצמצום השימוש בטוקנים עד 80% לכל שאילתה – ה-Athena בוחר באופן אוטומטי את הכישורים המתאימים ביותר לכל בקשה.",
        "max-tools": {
          title: "כלים של מקס",
          description:
  ...
  customization: {
    ...
    items: {
      ...
      "display-language": {
        title: "שפת תצוגה",
        description:
          "בחר את השפה המועדפת להצגת ממשק המשתמש של Athena - כאשר תרגומים זמינים.",
      },
      logo: {
        title: "לוגו מותג",
  ...
  api: {
    title: "מפתחות API",
    description:
      "מפתחות API מאפשרים למחזיק בהם לגשת ולנהל באופן תכנותי את מופע Athena זה.",
    ...
    modal: {
      ...
      create: "צור מפתח API",
      helper:
        "לאחר יצירתו, ניתן להשתמש במפתח ה-API כדי לגשת למופע Athena זה ולהגדיר אותו באופן תכנותי.",
      name: {
        label: "שם",
  ...
  llm: {
    title: "העדפות מודל שפה (LLM)",
    description:
      "אלה האישורים וההגדרות עבור ספק הצ'אט וההטמעה המועדף עליך. חשוב שמפתחות אלה יהיו עדכניים ונכונים, אחרת Athena לא יפעל כראוי.",
    provider: "ספק LLM",
    providers: {
      azure_openai: {
  ...
  transcription: {
    ...
    provider: "ספק תמלול",
    "warn-start":
      "שימוש במודל ה-whisper המקומי על מכונות עם זיכרון RAM או מעבד מוגבלים עלול לגרום להאטה של Athena בעת עיבוד קובצי מדיה.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "הטמעה היא תהליך של הפיכת טקסט לווקטורים. אישורים אלה נדרשים כדי להפוך את הקבצים וההנחיות שלך לפורמט ש-Athena יכול להשתמש בו לעיבוד.",
    provider: {
      title: "ספק הטמעה",
    },
  },
  ...
  vector: {
    ...
    description:
      "אלה האישורים וההגדרות לאופן פעולת מופע ה-Athena שלך. חשוב שמפתחות אלה יהיו עדכניים ונכונים.",
    provider: {
  ...
  privacy: {
    ...
    description:
      "זוהי התצורה שלך לאופן שבו ספקים צד שלישי מחוברים ו-Athena מטפלים בנתונים שלך.",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "קבצים אלה יועלו למעבד המסמכים הפועל במופע זה של Athena. קבצים אלה אינם נשלחים או משותפים עם צד שלישי.",
    },
    pinning: {
      what_pinning: "מהי הצמדת מסמכים?",
      pin_explained_block1:
        "כאשר אתה <b>מצמיד</b> מסמך ב-Athena, אנו נזריק את כל תוכן המסמך לחלון ההנחיה שלך כדי שמודל השפה שלך יבין אותו במלואו.",
      pin_explained_block2:
        "זה עובד בצורה הטובה ביותר עם <b>מודלים בעלי הקשר רחב</b> או קבצים קטנים שהם קריטיים לבסיס הידע שלו.",
      pin_explained_block3:
        "אם אינך מקבל את התשובות הרצויות מ-Athena כברירת מחדל, הצמדה היא דרך מצוינת לקבל תשובות איכותיות יותר בלחיצה אחת.",
      accept: "אוקיי, הבנתי",
    },
    watching: {
      what_watching: "מה עושה מעקב אחר מסמך?",
      watch_explained_block1:
        "כאשר אתה <b>עוקב</b> אחר מסמך ב-Athena, אנו נסנכרן <i>אוטומטית</i> את תוכן המסמך שלך ממקורו המקורי במרווחי זמן קבועים. זה יעדכן אוטומטית את התוכן בכל סביבת עבודה שבה קובץ זה מנוהל.",
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          title: "נדרש אימות",
          description:
            "עליך להתאמת עם מרכז הקהילה של Athena לפני פרסום פריטים.",
  ...
  security: {
    ...
    password: {
      title: "הגנת סיסמה",
      description:
        "הגן על מופע ה-Athena שלך באמצעות סיסמה. אם תשכח אותה, אין שיטת שחזור, אז ודא שאתה שומר סיסמה זו.",
  ...
  telegram: {
    title: "בוט של טלגרם",
    description:
      "חברו את ההתקנה של Athena ל-Telegram, כך שתוכלו לתקשר עם סביבות העבודה שלכם ממכשיר כלשהו.",
    setup: {
      step1: {

...
const TRANSLATIONS = {
  ...
  agent: {
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        ...
        "beta-badge": "بيتا",
        description:
          "تمكين استخدام أدوات غير محدودة وتقليل استخدام رموز القطع بنسبة تصل إلى 80٪ لكل استعلام - يقوم Athena تلقائيًا باختيار المهارات المناسبة لكل طلب.",
        "max-tools": {
          title: "أدوات ماكس",
          description:
  ...
  api: {
    ...
    modal: {
      ...
      helper:
        "بمجرد إنشائه، يمكن استخدام مفتاح API للوصول إلى مثيل Athena هذا وإدارته برمجيًا.",
      name: {
        label: "الاسم",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "سيتم تحميل هذه الملفات إلى معالج المستندات الذي يعمل على هذه نسخة من Athena. هذه الملفات لا يتم إرسالها أو مشاركتها مع طرف ثالث.",
    },
    pinning: {
      what_pinning: 'ما هو عمل "تثبيت المستندات"؟',
      pin_explained_block1:
        "عندما تقوم بإرفاق مستند في Athena، سنقوم بإدخال محتوى المستند بالكامل في نافذة المطالبة الخاصة بـ LLM الخاص بك، وذلك حتى يتمكن LLM من فهم المحتوى بالكامل.",
      pin_explained_block2:
        "يعمل هذا بشكل أفضل مع **نماذج ذات سياق كبير** أو ملفات صغيرة ولكنها ضرورية لأساس المعرفة الخاص بها.",
      pin_explained_block3:
        'إذا لم تحصل على الإجابات التي ترغب بها بشكل افتراضي من Athena، فإن استخدام ميزة "التثبيت" هو طريقة رائعة للحصول على إجابات ذات جودة أعلى في نقرة واحدة.',
      accept: "حسناً، فهمت.",
    },
    watching: {
      what_watching: "ما الذي يفعله مشاهدة فيلم وثائقي؟",
      watch_explained_block1:
        "عندما **تشاهد** مستندًا في Athena، سيتم **مزامنة** محتوى المستند تلقائيًا من مصدره الأصلي على فترات منتظمة. وهذا سيؤدي إلى تحديث المحتوى تلقائيًا في كل مساحة عمل حيث يتم إدارة هذا الملف.",
  ...
  customization: {
    ...
    branding: {
      ...
      description:
        "قم بتخصيص نسخة Athena الخاصة بك باستخدام العلامات التجارية الخاصة بك.",
    },
    chat: {
      title: "دردشة",
    ...
    items: {
      ...
      "display-language": {
        ...
        description:
          "حدد اللغة المفضلة لعرض واجهة مستخدم Athena - عند توفر الترجمات.",
      },
      logo: {
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          title: "يتطلب التحقق",
          description:
            "يجب عليك التحقق من هويتك مع مركز مجتمع Athena قبل نشر أي محتوى.",

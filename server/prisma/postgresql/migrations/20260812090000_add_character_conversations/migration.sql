...
ALTER TABLE "responses_conversations" ADD COLUMN "softCloseDueAt" TIMESTAMP(3);
ALTER TABLE "responses_conversations" ADD COLUMN "suspensionReason" TEXT;
ALTER TABLE "responses_conversations" ADD COLUMN "suspendedAt" TIMESTAMP(3);
ALTER TABLE "responses_conversations" ADD COLUMN "endedAt" TIMESTAMP(3);
...
CREATE TABLE "character_conversation_turns" (
    ...
    CONSTRAINT "character_conversation_turns_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "character_conversation_events" (
    ...
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "character_conversation_events_pkey" PRIMARY KEY ("id")
);

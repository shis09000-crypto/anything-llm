...
ALTER TABLE "athena_3d_character_memory_profiles" ADD COLUMN "coreId" TEXT;
ALTER TABLE "athena_3d_character_memory_profiles" ADD COLUMN "coreVersion" TEXT;
ALTER TABLE "athena_3d_character_memory_profiles" ADD COLUMN "coreSha256" TEXT;
ALTER TABLE "athena_3d_character_memory_profiles" ADD COLUMN "coreSnapshotJson" TEXT;
ALTER TABLE "athena_3d_character_memory_profiles" ADD COLUMN "adaptiveSelfJson" TEXT;
ALTER TABLE "athena_3d_character_memory_profiles" ADD COLUMN "relationshipV2Json" TEXT;
ALTER TABLE "athena_3d_character_memory_profiles" ADD COLUMN "userModelSummaryJson" TEXT;
ALTER TABLE "athena_3d_character_memory_profiles" ADD COLUMN "reflectionVersion" TEXT NOT NULL DEFAULT '2.0';
ALTER TABLE "athena_3d_character_memory_profiles" ADD COLUMN "policyVersion" TEXT NOT NULL DEFAULT '2.0';

ALTER TABLE "athena_3d_character_memory_sessions" ADD COLUMN "reflectionJson" TEXT;
ALTER TABLE "athena_3d_character_memory_sessions" ADD COLUMN "formationStatus" TEXT NOT NULL DEFAULT 'pending';
ALTER TABLE "athena_3d_character_memory_sessions" ADD COLUMN "legacyReflectionPending" BOOLEAN NOT NULL DEFAULT false;

ALTER TABLE "athena_3d_character_memory_revisions" ADD COLUMN "relationshipV2BeforeJson" TEXT;
ALTER TABLE "athena_3d_character_memory_revisions" ADD COLUMN "relationshipV2DeltaJson" TEXT;
ALTER TABLE "athena_3d_character_memory_revisions" ADD COLUMN "relationshipV2AfterJson" TEXT;
ALTER TABLE "athena_3d_character_memory_revisions" ADD COLUMN "adaptiveBeforeJson" TEXT;
ALTER TABLE "athena_3d_character_memory_revisions" ADD COLUMN "adaptiveDeltaJson" TEXT;
ALTER TABLE "athena_3d_character_memory_revisions" ADD COLUMN "adaptiveAfterJson" TEXT;

ALTER TABLE "athena_3d_character_memory_jobs" ADD COLUMN "schemaVersion" INTEGER NOT NULL DEFAULT 2;
ALTER TABLE "athena_3d_character_memory_jobs" ADD COLUMN "taskKind" TEXT NOT NULL DEFAULT 'reflection';

CREATE TABLE "athena_3d_character_memory_candidates" (
  "id" TEXT NOT NULL PRIMARY KEY, "profileId" TEXT NOT NULL, "memorySessionId" TEXT NOT NULL,
  "finalizationEpoch" INTEGER NOT NULL, "candidateKey" TEXT NOT NULL, "type" TEXT NOT NULL,
  "firstPersonMemory" TEXT NOT NULL, "eventSummary" TEXT NOT NULL, "valuesJson" TEXT NOT NULL,
  "confidence" REAL NOT NULL, "tagsJson" TEXT NOT NULL, "proposedPersistence" TEXT NOT NULL,
  "decision" TEXT NOT NULL DEFAULT 'pending', "decisionReason" TEXT,
  "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, "lastUpdatedAt" DATETIME NOT NULL
);
...
CREATE TABLE "athena_3d_character_user_model_entries" (
  "id" TEXT NOT NULL PRIMARY KEY, "profileId" TEXT NOT NULL, "observation" TEXT NOT NULL,
  "firstPersonInterpretation" TEXT NOT NULL, "confidence" REAL NOT NULL, "status" TEXT NOT NULL DEFAULT 'active',
  "occurrenceCount" INTEGER NOT NULL DEFAULT 1, "sourceSessionCount" INTEGER NOT NULL DEFAULT 1,
  "fingerprint" TEXT NOT NULL, "indexStatus" TEXT NOT NULL DEFAULT 'pending', "indexAttempts" INTEGER NOT NULL DEFAULT 0,
  "indexLeaseOwner" TEXT, "indexLeaseExpiresAt" DATETIME, "embeddingModel" TEXT, "embeddingVersion" TEXT,
  "indexedAt" DATETIME, "indexError" TEXT, "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, "lastUpdatedAt" DATETIME NOT NULL
);
...
CREATE TABLE "athena_3d_character_memories" (
  "id" TEXT NOT NULL PRIMARY KEY, "profileId" TEXT NOT NULL, "type" TEXT NOT NULL,
  "firstPersonMemory" TEXT NOT NULL, "eventSummary" TEXT NOT NULL, "importance" REAL NOT NULL,
  "relationshipValue" REAL NOT NULL, "emotionalValue" REAL NOT NULL, "futureRelevance" REAL NOT NULL,
  "characterImpact" REAL NOT NULL, "confidence" REAL NOT NULL, "persistence" TEXT NOT NULL,
  "tagsJson" TEXT NOT NULL, "fingerprint" TEXT NOT NULL, "status" TEXT NOT NULL DEFAULT 'active',
  "indexStatus" TEXT NOT NULL DEFAULT 'pending', "indexAttempts" INTEGER NOT NULL DEFAULT 0,
  "indexLeaseOwner" TEXT, "indexLeaseExpiresAt" DATETIME, "embeddingModel" TEXT, "embeddingVersion" TEXT,
  "indexedAt" DATETIME, "indexError" TEXT, "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, "lastUpdatedAt" DATETIME NOT NULL
);
...
CREATE TABLE "athena_3d_character_memory_evidence" (
  "id" TEXT NOT NULL PRIMARY KEY, "profileId" TEXT NOT NULL, "subjectType" TEXT NOT NULL, "subjectId" TEXT NOT NULL,
...
CREATE TABLE "athena_3d_character_growth_nodes" (
  "id" TEXT NOT NULL PRIMARY KEY, "profileId" TEXT NOT NULL, "type" TEXT NOT NULL, "firstPersonSummary" TEXT NOT NULL,
  "changesJson" TEXT NOT NULL, "confidence" REAL NOT NULL, "fingerprint" TEXT NOT NULL, "status" TEXT NOT NULL DEFAULT 'active',
  "indexStatus" TEXT NOT NULL DEFAULT 'pending', "indexAttempts" INTEGER NOT NULL DEFAULT 0, "indexLeaseOwner" TEXT,
  "indexLeaseExpiresAt" DATETIME, "embeddingModel" TEXT, "embeddingVersion" TEXT, "indexedAt" DATETIME, "indexError" TEXT,
  "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, "lastUpdatedAt" DATETIME NOT NULL
);
...
CREATE TABLE "athena_3d_character_emotional_milestones" (
  "id" TEXT NOT NULL PRIMARY KEY, "profileId" TEXT NOT NULL, "type" TEXT NOT NULL, "firstPersonMemory" TEXT NOT NULL,
  "confidence" REAL NOT NULL, "fingerprint" TEXT NOT NULL, "status" TEXT NOT NULL DEFAULT 'active',
  "indexStatus" TEXT NOT NULL DEFAULT 'pending', "indexAttempts" INTEGER NOT NULL DEFAULT 0, "indexLeaseOwner" TEXT,
  "indexLeaseExpiresAt" DATETIME, "embeddingModel" TEXT, "embeddingVersion" TEXT, "indexedAt" DATETIME, "indexError" TEXT,
  "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, "lastUpdatedAt" DATETIME NOT NULL
);
...
UPDATE "athena_3d_character_memory_profiles"
SET "coreId"='athena.core.cold_tsundere', "coreVersion"='2.0.0',
    ...
    "relationshipV2Json"=COALESCE("relationshipV2Json", json_object('familiarity',COALESCE(json_extract("relationshipJson",'$.closeness'),0),'trust',COALESCE(json_extract("relationshipJson",'$.trust'),0),'comfort',COALESCE(json_extract("relationshipJson",'$.comfort'),0),'attachment',COALESCE(json_extract("relationshipJson",'$.affection'),0),'openness',1-COALESCE(json_extract("relationshipJson",'$.guardedness'),1),'physical_closeness',0))

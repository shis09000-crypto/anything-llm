ALTER TABLE "character_conversation_turns" ADD COLUMN "expectedMemoryRevision" INTEGER NOT NULL DEFAULT 0;
ALTER TABLE "character_conversation_turns" ADD COLUMN "memoryStatus" TEXT NOT NULL DEFAULT 'preparing';
ALTER TABLE "character_conversation_turns" ADD COLUMN "memoryCommitAttempts" INTEGER NOT NULL DEFAULT 0;
ALTER TABLE "character_conversation_turns" ADD COLUMN "memoryErrorCode" TEXT;
ALTER TABLE "character_conversation_turns" ADD COLUMN "memoryCommittedAt" DATETIME;

...
const DOMAIN_CLASSIFICATIONS = Object.freeze({
  ...
  localRuntime: DATA_ACCESS_CLASSIFICATIONS.sensitive,
  ...
  workspaceThreadGoal: DATA_ACCESS_CLASSIFICATIONS.user,
  workspaceThreadPlan: DATA_ACCESS_CLASSIFICATIONS.user,

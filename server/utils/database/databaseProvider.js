...
const MAIN_ROLE_DATABASE_URLS = Object.freeze({
  ...
  "responses-runtime": "ATHENA_RESPONSES_DATABASE_URL",
  "character-performance-runtime": "ATHENA_CHARACTER_PERFORMANCE_DATABASE_URL",
  "local-runtime-center": "ATHENA_LOCAL_RUNTIME_DATABASE_URL",
  ...
  "browser-egress": "ATHENA_BROWSER_EGRESS_DATABASE_URL",
  ...
  "coordination-plane": "ATHENA_COORDINATION_DATABASE_URL",
...
function connectionBudget(env = process.env, role = poolRole(env)) {
  const defaults = {
    ...
    "model-gateway": 3,
    "responses-runtime": 6,
    "character-performance-runtime": 6,
    "tool-broker": 6,
    "crypto-market": 4,
    "crypto-account": 4,
    "crypto-forecast": 3,
